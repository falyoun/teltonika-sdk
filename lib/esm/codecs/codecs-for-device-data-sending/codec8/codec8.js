...
var base_codec_1 = require("../../base-codec");
var utils_1 = require("../../../utils");
var codecs_1 = require("../..");
var Codec8 = /** @class */ (function (_super) {
    __extends(Codec8, _super);
    function Codec8(reader, codecType) {
        var _this = _super.call(this, reader, codecType) || this;
        _this._gpsPrecision = 10000000;
        return _this;
    }
    Codec8.prototype._parseIoElements = function () {
        var ioElement = [];
    ...
    Codec8.prototype.decodeBody = function () {
        var body = this.tcpTeltonikaPacket.body;
        for (var i = 0; i < this.tcpTeltonikaPacket.header.numberOfRecords1; i++) {
            var avlRecord = {
