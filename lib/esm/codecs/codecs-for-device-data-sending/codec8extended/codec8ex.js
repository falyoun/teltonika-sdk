...
var codec8extended_io_elements_1 = require("./codec8extended-io-elements");
    ...
    Codec8ex.prototype.parseIoElements = function () {
        ...
        (function () {
            ...
            for (var i = 0; i < ioCountInt8; i++) {
                ...
                ioElement.push(utils_1.prepareIOEntity(property_id, value, codec8extended_io_elements_1.Codec8extendedIoElements));
            }
        })();
        // 2 byte
        (function () {
