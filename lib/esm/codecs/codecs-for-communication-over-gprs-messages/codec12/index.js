...
var Codec12 = /** @class */ (function (_super) {
    ...
    function Codec12(reader, codecType) {
        var _this = this;
        if (codecType !== codecs_1.CodecsTypesEnum.COMMUNICATION_OVER_GPRS_CODEC) {
            throw {
                message: "Codec12 is of type " + codecs_1.CodecsTypesEnum.COMMUNICATION_OVER_GPRS_CODEC,
                error: 'Mis-match type'
            };
        }
        _this = _super.call(this, reader, codecType) || this;
        return _this;
    }
