...
var teltonika_packets_parser_1 = require("./teltonika-packets-parser");
var testCodec8 = function () {
    ...
    var teltonikaPacketsParser = new teltonika_packets_parser_1.TeltonikaPacketsParser(buff);
...
var testCodec16 = function () {
    ...
    var parser = new teltonika_packets_parser_1.TeltonikaPacketsParser(buff);
...
var testCodec12 = function () {
    ...
    var fromDeviceTeltonikaPacketsParser = new teltonika_packets_parser_1.TeltonikaPacketsParser(buffer);
    console.log(fromDeviceTeltonikaPacketsParser.avl);
};
var testCodec13 = function () {
    var codec13packet = '00000000000000170D0105000000070A81C320676574696E666F0100006855';
    var buff = Buffer.from(codec13packet, 'hex');
    var teltonikaPacketsParser = new teltonika_packets_parser_1.TeltonikaPacketsParser(buff);
    console.log(teltonikaPacketsParser.avl);
};
function bootstrap() {
